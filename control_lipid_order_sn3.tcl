...
mol load pdb inter_lip_1242atom.pdb dcd control_inter_lipid_8ns.dcd
#set textA "{name C21 or name C22 or name C23 or name C24 or name C25 or name C26 or name C27 or name C28 or name C29 or name C210 or name C211 or name C212 } and {resid 25 31 34}"
#set textB "{name C23 or name C24 or name C25 or name C26 or name C27 or name C28 or name C29 or name C210 or name C211 or name C212 or name C213 or name C214 } and {resid 25 31 34}"
set textA "name C31 or name C32 or name C33 or name C34 or name C35 or name C36 or name C37 or name C38 or name C39 or name C310 or name C311 or name C312"
set textB "name C33 or name C34 or name C35 or name C36 or name C37 or name C38 or name C39 or name C310 or name C311 or name C312 or name C313 or name C314"
...
#------------------------------------------------------------------------
set file1 "control_interfacial_lip_order_sn3.dat"
